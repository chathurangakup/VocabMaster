...
export const lessionListArray = [
    {
        id:1,
        title:'Human body (part 1)',
        spellingList : [
            {
                id:1,
                title: 'brain',
    ...
    {
        id:2,
        title:'Human body (part 2)'
    },
    {
        id:3,
        title:'Enviornment (part 1)'
    },
    {
        id:4,
        title:'Enviornment (part 2)'
    },
    {
        id:5,
        title:'Enviornment (part 1)'
...
export const vocabResponce = [
    {
      ...
      "phonetics": [
        {
          "text": "/hɛlp/",
          "audio": "https://api.dictionaryapi.dev/media/pronunciations/en/help-us.mp3",
          "sourceUrl": "https://commons.wikimedia.org/w/index.php?curid=296100",
          "license": {
            "name": "BY-SA 3.0",
      ...
      "meanings": [
        {
          ...
          "definitions": [
            ...
            {
              "definition": "To assist (a person) in getting something, especially food or drink at table; used with to.",
              "synonyms": [],
              "antonyms": [],
            ...
            {
              "definition": "To avoid; to prevent; to refrain from; to restrain (oneself). Usually used in nonassertive contexts with can.",
              "synonyms": [],
              "antonyms": [],
        ...
        },
        {
          ...
          "definitions": [
            {
              "definition": "A cry of distress or an urgent request for assistance",
              "synonyms": [],
              "antonyms": [],
              "example": "— Take that, you scoundrel.\n— Help! Robin, help!"
            }
          ],
          "synonyms": [],
          "antonyms": []
